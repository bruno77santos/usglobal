        ...
        switch (urlTest) {
            case 'Investimentos nos Estados Unidos: oportunidade ou estratégia?':
                result = <>
                    ...
                    <section className='w-[90%] max-w-[1261px] mx-auto mt-52'>
                        <Breadcrumbs dir={[{ title: "Blog", url: "/blog" }, { title: "Investimentos nos Estados Unidos: oportunidade ou estratégia?", url: "/blog/investimentos-nos-estados-unidos-oportunidade-ou-estrategia", end: true }]} />
                ...
                break;
            case 'Enfim, os americanos escolheram Trump. E agora?':
                result = <>
                    <section className=' w-[90%] max-w-[1261px] mx-auto mt-52'>
                        <Breadcrumbs dir={[{ title: "Blog", url: "/blog" }, { title: "Enfim, os americanos escolheram Trump. E agora?", url: "/blog/enfim-os-americanos-escolheram-trump-e-agora", end: true }]} />
                ...
                break;
            case 'Paraísos fiscais: legítimos ou não?':
                result = <>
                    <section className='mt-52 w-[90%] max-w-[1261px] mx-auto'>
                        <Breadcrumbs dir={[{ title: "Blog", url: "/blog" }, { title: "Paraísos fiscais: legalidade e estratégia de proteção patrimonial", url: "/blog/paraisos-fiscais-legitimos-ou-nao", end: true }]} />
                ...
                break;
            case 'Estados Unidos: terra fértil para investimentos':
                result = <>
                    <section className='mt-52 w-[90%] max-w-[1261px] mx-auto'>
                        <Breadcrumbs dir={[{ title: "Blog", url: "/blog" }, { title: "Estados Unidos: terra fértil para investimentos", url: "/blog/estados-unidos-terra-fertil-para-investimentos", end: true }]} />
                        <h1 className='text-[48px] font-[700] text-white leading-[70px]'>
                ...
                break;
            case 'Como montar uma carteira de investimentos no exterior?':
                result = <>
                    <section className='mt-52 w-[90%] max-w-[1261px] mx-auto'>
                        <Breadcrumbs dir={[{ title: "Blog", url: "/blog" }, { title: "Como montar uma carteira de investimentos no exterior", url: "/blog/como-montar-uma-carteira-de-investimentos-no-exterior", end: true }]} />
                        <h1 className='text-[48px] font-[700] text-white leading-[70px]'>
                ...
                break;
            case 'Meu capital está mesmo seguro fora do país?':
                result = <>

                    <section className='mt-52 w-[90%] max-w-[1261px] mx-auto'>
                        <Breadcrumbs dir={[{ title: "Blog", url: "/blog" }, { title: "Meu capital está mesmo seguro fora do país?", url: "/blog/meu-capital-esta-mesmo-seguro-fora-do-pais", end: true }]} />
                ...
                break;
            case 'Porque expatriar meu capital com o Dólar em alta?':
                result = <>
                    <section className='mt-52 w-[90%] max-w-[1261px] mx-auto'>
                        <Breadcrumbs dir={[{ title: "Blog", url: "/blog" }, { title: "Porque expatriar meu capital com o Dólar em alta?", url: "/blog/porque-expatriar-meu-capital-com-o-dolar-em-alta", end: true }]} />
                ...
                break;
            case 'Europa, China, Japão e Emergentes: oportunidades, potenciais e riscos envolvidos':
                result = <>
                    <section className='mt-52 w-[90%] max-w-[1261px] mx-auto'>
                        <Breadcrumbs dir={[{ title: "Blog", url: "/blog" }, { title: "Europa, China, Japão e Emergentes: oportunidades, potenciais e riscos envolvidos", url: "/blog/europa-china-japao-e-emergentes-oportunidades-potenciais-e-riscos", end: true }]} />
                ...
                break;
            case 'Joint Tenancy: o que é e como usar?':
                result = <>
                    <section className='mt-52 w-[90%] max-w-[1261px] mx-auto'>
                        <Breadcrumbs dir={[{ title: "Blog", url: "/blog" }, { title: "Joint Tenancy: o que é e quais são seus benefícios?", url: "/blog/joint-tenancy-o-que-e-e-como-usar", end: true }]} />
                ...
                break;
            case 'Deixar o país? A “Teoria das Bandeiras” de Harry Schultz e saída fiscal no Brasil.':
                result = <>
                    <section className='mt-52 w-[90%] max-w-[1261px] mx-auto'>
                        <Breadcrumbs dir={[{ title: "Blog", url: "/blog" }, { title: "A saída fiscal e a teoria das bandeiras: oportunidades para otimizar seus recursos", url: "/blog/deixar-o-pais-teoria-das-bandeiras-de-harry-schultz-e-saida-fiscal-no-brasil", end: true }]} />
                        <h1 className='text-[48px] font-[700] text-white leading-[70px]'>
            ...
            case 'Investimentos nos Estados Unidos: oportunidade ou estratégia?':
                result = <>
                    <section className='mt-52 w-[90%] max-w-[1261px] mx-auto'>
                        <Breadcrumbs dir={[{ title: "Blog", url: "/blog" }, { title: "Investimentos nos Estados Unidos: oportunidade ou estratégia?", url: "/blog/investimentos-nos-estados-unidos-oportunidade-ou-estratégia", end: true }]} />
                        <h1 className='text-[48px] font-[700] text-white leading-[70px]'>
                ...
                break;
            case 'A crise de 2008: um divisor de águas':
                result = <>
                    <section className='mt-52 w-[90%] max-w-[1261px] mx-auto'>
                        <Breadcrumbs dir={[{ title: "Blog", url: "/blog" }, { title: "A crise de 2008: um divisor de água", url: "/blog/a-crise-de-2008-um-divisor-de-aguas", end: true }]} />
                        <h1 className='text-[48px] font-[700] text-white leading-[70px]'>
