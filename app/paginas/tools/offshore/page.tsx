          ...
          <div className="relative w-full max-w-xl bg-[#0C1D2C] text-white rounded-lg shadow-xl p-6 max-h-[90vh] overflow-y-auto scrollbar-thin scrollbar-thumb-[#FF0C34]/60">
            ...
            <div className="flex flex-col gap-4">
              ...
              <fieldset className="space-y-4 mt-4">
                <legend className="text-lg font-semibold mb-2">Investe na XP?</legend>
                {['Sim', 'Não'].map((resposta) => (
                  <label key={resposta} className="flex items-center gap-2">
                    <input
                      type="radio"
                      name="investeNaXP"
              ...
              <fieldset className="space-y-4 mt-4">
                <legend className="text-lg font-semibold mb-2">Quanto tem investido?</legend>
                {[
              ...
              <fieldset className="space-y-4 mt-4">
                <legend className="text-lg font-semibold mb-2">Investe no exterior?</legend>
                {['Sim', 'Não'].map((resposta) => (
                  <label key={resposta} className="flex items-center gap-2">
                    <input
                      type="radio"
